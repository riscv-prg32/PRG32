...
The only wireless HID device is a Bluetooth **LE** keyboard (HID over GATT);
the C6 has no Bluetooth Classic, see [bluetooth_keyboard.md](../hardware/bluetooth_keyboard.md).
