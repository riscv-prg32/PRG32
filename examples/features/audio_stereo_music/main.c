...
static const uint8_t lead_wave[] = {
    128, 180, 225, 245, 225, 180, 128, 76, 31, 11, 31, 76,
};
...
static const prg32_audio_event_t song[] = {
    {0, PRG32_AUDIO_CMD_NOTE_ON, 0, 60}, {4, PRG32_AUDIO_CMD_NOTE_OFF, 0, 0},
    {0, PRG32_AUDIO_CMD_NOTE_ON, 0, 67}, {4, PRG32_AUDIO_CMD_NOTE_OFF, 0, 0},
...
void app_main(void) {
  ...
  prg32_audio_config_t config = {
      .sample_rate = PRG32_AUDIO_SAMPLE_RATE,
      .mode = PRG32_AUDIO_MODE_STEREO,
      .max_voices = PRG32_AUDIO_MAX_VOICES,
      .gpio_bclk = PRG32_PIN_AUDIO_BCLK,
      .gpio_lrclk = PRG32_PIN_AUDIO_LRCLK,
      .gpio_data = PRG32_PIN_AUDIO_DATA,
      .gpio_sd = PRG32_PIN_AUDIO_SD,
  };
  prg32_audio_init(&config);
  prg32_audio_register_sample(0, lead_wave, sizeof(lead_wave), 60,
                              PRG32_AUDIO_SAMPLE_LOOP, 0, sizeof(lead_wave));
