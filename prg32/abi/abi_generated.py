...
ABI_MINOR = 7
ABI_HASH = 0xd8ded1a3
COMPATIBLE_ABI_HASHES = [6563778, 1810294992, 638542134]
IMPORT_NAMES = [
    'prg32_ticks_ms',
    'prg32_input_read',
    ...
    'prg32_palette_set',
    'prg32_palette_get',
    'prg32_gfx_pixel_indexed',
    'prg32_gfx_rect_indexed',
    'prg32_gfx_clear_indexed',
    'prg32_random_number',
    'prg32_btkbd_state',
    'prg32_btkbd_read_key',
    'prg32_btkbd_modifiers',
    'prg32_btkbd_key_down',
    'prg32_btkbd_flush',
    'prg32_btkbd_set_mapping',
