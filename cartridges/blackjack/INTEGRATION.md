...
If a CLI spelling changes, consult `docs/software/cartridges.md`, `docs/tools/audio.md`, and the Cartridge Store documentation and adjust `build.sh`; the game source/API targets are isolated from those host-side command spellings.
